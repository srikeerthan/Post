...
class RegistrationForm(forms.Form):
    username = forms.RegexField(regex=r'^\w+$', widget=forms.TextInput(attrs=dict(required=True, max_length=16)),
    ...
    def has_error(self, field, code=None):
        return super(RegistrationForm, self).has_error(field, code)
